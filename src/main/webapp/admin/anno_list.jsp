		...
		<table class="tablelist">
			<thead>
				<tr>
					...
					<th width="200px">通告标题</th>
					<th width="200px">通告内容</th>
			...
			<tbody>
				<s:iterator value="listanno" var="annoInfo">
					<tr onclick="getIndex(<s:property value="#annoInfo.id" />)"
						class="annoInfo<s:property value="#annoInfo.id" />">
						<td><s:property value="#annoInfo.id" /></td>
						<td><s:property value="#annoInfo.announcetitle" /></td>
						<td><s:property value="#annoInfo.announceinfo" /></td>
						<td><a
							href="anno_GoUpdateInfo.action?index=<s:property value="#annoInfo.id" />">更新</a>
						</td>
					...
					<div class="tip">
						...
						<div class="tipbtn">
							<form action="anno_DeleteInfo.action" method="post">
								<input name="index" value="<s:property value="#annoInfo.id" />"
