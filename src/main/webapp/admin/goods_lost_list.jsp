	...
	<div class="rightinfo">
		<table class="tablelist">
			<thead>
				<tr>
					...
					<th width="300px">失物信息标题</th>
					<th width="120px">物品所属类别</th>
					<th width="120px">物品丢失区域</th>
			...
			<tbody>
				<s:iterator value="listLostGoods" var="lostGoodsInfo">
					<tr onclick="getIndex(<s:property value="#lostGoodsInfo.id" />)"
						class="lostGoodsInfo<s:property value="#lostGoodsInfo.id" />">
						<td><s:property value="#lostGoodsInfo.id" /></td>
						<td><s:property value="#lostGoodsInfo.goodsname" /></td>
						<td><s:property value="#lostGoodsInfo.goodstype.typename" /></td>
						<td><s:property value="#lostGoodsInfo.goodsarea.areaname" /></td>
						<td><s:date name="#lostGoodsInfo.goodstime" format="yyyy-mm-dd" /> </td>
						<td><s:property value="#lostGoodsInfo.goodsuser.usernickname" /></td>
						<td><font
							style="color: red;cursor:pointer;" id="<s:property value="#lostGoodsInfo.id" />" onclick="return reverse(this.id);" class="reverse">删除</font></td>
					</tr>
					<div class="tip">
						<div class="tiptop">
							<span>提示信息</span><a></a>
						...
						<div class="tipbtn">
							<form action="goods_DeleteInfo.action">
								<input name="index" value="0" class="deleteId"
									type="hidden"><input name="goodsStatus" value="<s:property value="#lostGoodsInfo.goodsstatus" />"
		...
		<div class="pagin">
			...
			<ul class="paginList">
				...
				%>
				<li class="paginItem"><a
					href="area_GetAll.action?nowPage=<%=i%>"><%=i%></a>
				</li>
				<%
					}
				%>
