...
<body class="newSelectType_Body">
	...
	<div class="newSelectType_select">
		<div class="goodsInfoTop">
			<img src="image/tzico.jpg"><img src="image/found.jpg"></img>
		</div>
		<div
			...
			<table class="tablelist">
				...
				<tbody>
					<s:iterator value="listFoundGoods" var="foundGoodsInfo">
						<tr class="foundGoodsInfo<s:property value="#foundGoodsInfo.id" />">
							<td><div
							...
							<td><s:property
									value="#foundGoodsInfo.goodsuser.usernickname" /></td>
