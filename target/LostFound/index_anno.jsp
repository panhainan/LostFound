...
<body class="index_anno_Body">
	<div class="index_anno_top">
		<div style="float: left;width: 80%"><img src="image/lastnew.jpg"></img><img src="image/announce.jpg"></img></div><div  style="float: left;height: 30px;line-height: 30px;font-family: 微软雅黑;width: 20%;font-size: 18px;"><a href="anno_Getlist.action" target="_top">&gt;&gt;</a></div>
	</div>
    <div class="tableDiv">
