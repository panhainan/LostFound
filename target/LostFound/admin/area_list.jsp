		...
		<table class="tablelist">
			<thead>
				<tr>
					...
					<th width="300px">地区名</th>
					<th width="200px">更新操作</th>
					<th width="200px">删除操作</th>
				</tr>
			</thead>
			<tbody>
				<s:iterator value="listArea" var="areaInfo">
					<tr onclick="getIndex(<s:property value="#areaInfo.id" />)"
						class="areaInfo<s:property value="#areaInfo.id" />">
						<td><s:property value="#areaInfo.id" /></td>
						<td><s:property value="#areaInfo.areaname" /></td>
						<td><a
							href="area_GoUpdateInfo.action?index=<s:property value="#areaInfo.id" />" >更新</a></td>
						<td><font
							style="color: red;cursor:pointer;"  id="<s:property value="#areaInfo.id" />" onclick="return reverse(this.id);"  class="reverse">删除</font></td>
					</tr>
					<div class="tip">
						<div class="tiptop">
							<span>提示信息</span><a></a>
						...
						<div class="tipbtn">
							<form action="area_DeleteInfo.action">
